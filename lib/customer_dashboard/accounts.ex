defmodule CustomerDashboard.Accounts do
  @moduledoc """
  ...
  alias CustomerDashboard.Accounts.{User, UserToken, UserNotifier}

  @doc """
  Creates a user and associates it with the application.
  """
  def create_user_and_complete_application(application, user_attrs) do
    Repo.transaction(fn ->
